...
public class HeapTest {
    public static void test(int n) {
        ...
        for(int i = 0; i < control.length; i++){
            ...
            if (test.size() == 0) System.out.println("Size Error");
            if (!test.peek().equals(control[i])) System.out.println("Peek Error");
            if (!test.poll().equals(control[i])) System.out.println("Poll Error");
